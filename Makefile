...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1528252320.0
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1528252320.0
...
ASM_FLAGS += -I../.
ASM_FLAGS += -I../mbed/.
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F401RE
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F401RE/TARGET_STM
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/TARGET_NUCLEO_F401RE
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4/TARGET_STM32F401xE/device
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F401RE/TARGET_STM/TARGET_STM32F4/device
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F401RE/TOOLCHAIN_GCC_ARM
...
flash:
	@echo
	@echo ">>>>>> SakiiR is Flashing ..."
	openocd -f /usr/share/openocd/scripts/board/st_nucleo_f4.cfg \
		-c "init; reset halt; flash write_image erase $(PROJECT).hex; exit"

	@echo
	@echo ">>>>>> SakiiR is Running!"
	openocd -f /usr/share/openocd/scripts/board/st_nucleo_f4.cfg \
